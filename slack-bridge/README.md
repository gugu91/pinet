...
Optional web control plane: install the separate `@gugu910/pi-pinet-web-control-plane` extension package for a disabled-by-default, broker-lock-gated, loopback-only, Basic-Auth-protected read-only dashboard. It is intentionally not bundled into `@gugu910/pi-slack-bridge`.
