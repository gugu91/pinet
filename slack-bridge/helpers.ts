...
export function buildWorkerPromptGuidelines(): string[] {
  return [
    ...
    "- Do not start or delegate changes to this repository's (gugu91/extensions) Pinet or Pi Slack Bridge surfaces unless the request names a GitHub issue/PR with clear maintainer priority/approval; if missing or unclear, ask first. This gate is scoped to gugu91/extensions Pinet/Slack Bridge work only. Outside those surfaces — for example unrelated repositories, other extensions, or general user-authorised work elsewhere — it imposes no issue/PR prerequisite; that work follows its own repository instructions and the requester's explicit authority.",
    "- When delegating, include the workflow (`ack/work/ask/report`), the task, issue/PR numbers and maintainer approval (for gate-covered gugu91/extensions Pinet/Slack Bridge work), repo/branch/worktree setup, important files, acceptance criteria, and where to reply.",
